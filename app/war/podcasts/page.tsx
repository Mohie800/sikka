...
import { useHorizontalScroll } from "../../component/useScroll";
...
} from "../../services/podcasts/podcastsApi";
...
const Page = () => {
  ...
  return (
    <div>
      <title>
        {currentLanguage == "ar"
          ? "  بودكاست - سكة 15 ابريل "
          : "Podcast - SIKKA 15 April "}
      </title>
        ...
        >
          <div className="podcast-hero-text-container">
            <Typo className="podcast-hero-main-text">
              Sikka Podcasts - 15 April
            </Typo>
            <Typo className="podcast-hero-sec-text">
              Narratives and audio recordings that capture the pulse of artistic
              practices and social movements in Sudan, documenting post-war
              transformations from the roots of the December Revolution to the
              present moment, where the rhythms of art and community engagement
              interact with the newly shaped post-war reality.
            </Typo>
          </div>
