...
import { useGetArticlesAllMutation } from "@/app/services/articles/articlesApi";
...
const All = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      await getArticlesAll({ id: "" });
    };
    fetchData();
    console.log("ddd");
  }, []);

  const [getArticlesAll, { data, isLoading }] = useGetArticlesAllMutation();
  if (isLoading || !data) {
